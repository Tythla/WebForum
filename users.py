...
class User:
    def __init__(self, user_id, key, username, is_moderator=False, mod_key=None, real_name=None, avatar_icon=None):
...
class UserManager:
    ...
    def create_moderator(self, username, real_name, avatar_icon):
        self.user_id_counter += 1
        user_key = os.urandom(24).hex()
        mod_key = os.urandom(24).hex()
        new_user = User(self.user_id_counter, user_key, username, True, mod_key, real_name, avatar_icon)
